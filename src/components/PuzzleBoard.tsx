...
/**
 * Mobile-first puzzle. Primary interaction:
 ...
 * so the client can never desync from authoritative state.
 */
export function PuzzleBoard({
  ...
  const ready = Object.keys(pieceSrcs).length >= total;
